...
## Build instructions
1. You need to have masm32 installed. You can get it from [this](https://www.masm32.com) website.
...
2. You run the included build script and you're done.
    - Using the option -c with Crinkler executable in the project folder will give "Crinkled" result.
